...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/training-details/{id}/requirements', function () {
    ...
    Route::post('/show-program/{id}', [AgencyController::class, 'application'])->middleware('role:PWD')->name('programs-application');
});