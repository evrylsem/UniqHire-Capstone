...
<div class="row d-flex align-items-center home-row mb-5 home-top border-bottom text-center user-count">
    <div class="col">
        <div class="d-flex flex-column justify-content-center text-center">
            <i class='bx bx-handicap home-icons'></i>
            <span>
                {{ $pwdCount }}
                <p>PWDs</p>
            </span>
    ...
    <div class="col">
        <div class="d-flex flex-column justify-content-center text-center">
            <i class='bx bxs-school home-icons'></i>
            <span>
                {{ $trainerCount }}
    ...
    <div class="col">
        <div class="d-flex flex-column justify-content-center text-center">
            <i class='bx bx-briefcase-alt-2 home-icons'></i>
            <span>
                {{ $employerCount }}
                <p>Companies</p>
            </span>
    ...
    <div class="col">
        <div class="d-flex flex-column justify-content-center text-center">
            <i class='bx bx-money-withdraw home-icons'></i>
            <span>
                {{ $sponsorCount }}
                <p>Sponsors</p>
            </span>
